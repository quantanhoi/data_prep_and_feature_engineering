...
include::chapters/01_tensorflow_horse_truck.adoc[]
...
include::chapters/05_pandas.adoc[]

<<<<
// 6. Runtime View
include::chapters/06_embedding.adoc[]

<<<<
// 7. Deployment View
include::chapters/07_multimodal_input.adoc[]
